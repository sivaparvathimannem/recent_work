...
echo_and_run cd "/home/ailand/GEM-main/gem_ws/src/move2point"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ailand/GEM-main/gem_ws/src/move2point/setup.py" \
     \
    build --build-base "/home/ailand/GEM-main/gem_ws/build/move2point" \
    install \
    --root="${DESTDIR-/}" \
