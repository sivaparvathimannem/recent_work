...
(cl:defmethod cl:initialize-instance :after ((m <point2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'point2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name etasb_msgs-msg:<point2D> is deprecated: use etasb_msgs-msg:point2D instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <point2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader etasb_msgs-msg:header-val is deprecated.  Use etasb_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <point2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader etasb_msgs-msg:x-val is deprecated.  Use etasb_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <point2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader etasb_msgs-msg:y-val is deprecated.  Use etasb_msgs-msg:y instead.")
  (y m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<point2D>)))
  ...
  (cl:format cl:nil "# a 2D point for ROS~%Header header~%~%float64 x~%float64 y~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'point2D)))
  "Returns full string definition for message of type 'point2D"
  (cl:format cl:nil "# a 2D point for ROS~%Header header~%~%float64 x~%float64 y~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
